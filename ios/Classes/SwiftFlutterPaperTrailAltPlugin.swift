...
public class SwiftFlutterPaperTrailAltPlugin: NSObject, FlutterPlugin {
    private static var programName: String?
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "flutter_papertrail_alt", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterPaperTrailAltPlugin()
    ...
    private func configureUserAndParseArguments(_ call: FlutterMethodCall, result: @escaping FlutterResult){
        ...
        paperTrailLogger.programName = userId + "--on--" + SwiftFlutterPaperTrailAltPlugin.programName!
    ...
    private func setupLoggerAndParseArguments(_ call: FlutterMethodCall, result: @escaping FlutterResult){
        ...
        SwiftFlutterPaperTrailAltPlugin.programName = programNameParam
        paperTrailLogger.programName = SwiftFlutterPaperTrailAltPlugin.programName
