package com.kuntal.flutterpapertrail
...
class FlutterPaperTrailAltPlugin : MethodCallHandler, FlutterPlugin {
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val plugin = FlutterPaperTrailAltPlugin()
    ...
    private fun onAttachedToEngine(messenger: BinaryMessenger) {
        channel = MethodChannel(
            ...
            .apply {
                setMethodCallHandler(this@FlutterPaperTrailAltPlugin)
            }
    }
